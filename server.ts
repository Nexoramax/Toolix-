...
app.get("/sitemap.xml", (req, res) => {
  ...
  const devPath = path.join(process.cwd(), "public", "sitemap.xml");
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    <loc>https://toolixappai.netlify.app/privacy-policy</loc>
    <changefreq>monthly</changefreq>
    <priority>0.5</priority>
  </url>
  <url>
    <loc>https://toolixappai.netlify.app/terms-of-service</loc>
    <changefreq>monthly</changefreq>
    <priority>0.5</priority>
  </url>
  <url>
  ...
  <url>
    <loc>https://toolixappai.netlify.app/security</loc>
    <changefreq>monthly</changefreq>
    <priority>0.7</priority>
  </url>
  <url>
  ...
  <url>
    <loc>https://toolixappai.netlify.app/404</loc>
    <changefreq>monthly</changefreq>
  ...
  <url>
    <loc>https://toolixappai.netlify.app/tools</loc>
    <changefreq>daily</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://toolixappai.netlify.app/favorites</loc>
    <changefreq>weekly</changefreq>
    <priority>0.4</priority>
  </url>
  <url>
    <loc>https://toolixappai.netlify.app/history</loc>
    <changefreq>weekly</changefreq>
    <priority>0.4</priority>
  </url>
  <url>
    <loc>https://toolixappai.netlify.app/settings</loc>
    <changefreq>monthly</changefreq>
    <priority>0.4</priority>
  </url>`;
...
function serveSEOIndex(req: express.Request, res: express.Response, next: express.NextFunction) {
